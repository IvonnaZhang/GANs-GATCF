...
def get_parser():
    ...
    # Training tool
    parser.add_argument('--device', type=str, default='cpu')  # gpu cpu mps cuda
    parser.add_argument('--bs', type=int, default=4096)  # NeuCF 256 CSMF 256 GraphMF 256 GATCF 4096
