...
from modules import get_model, EdgeModel
...
def RunOnce(args, runId, Runtime, log):
    ...
    print("final:", model.sub_user_embeds.weight)
...
if __name__ == '__main__':
    ...
    edge_user_embeds, edge_serv_embeds = EdgeModel.sub_user_embeds[0].weights, EdgeModel.sub_item_embeds[0].weights
    pk.dump(edge_user_embeds, open(f'datasets/data/partition/sub/subuser_embeds_1.pk', 'wb'))
    pk.dump(edge_serv_embeds, open(f'datasets/data/partition/sub/subserv_embeds_1.pk', 'wb'))
